  ...
  const tableColumn: ColumnDef<TableType>[] = useMemo(() => {
    return [
      ...
      },
      {
        ...
        header: 'Svc Level',
        cell: ({ row }) => (
          <span className="text-muted-foreground">{row.original.serviceLevel}</span>
        ),
      },
      {
        accessorKey: 'cvi',
      ...
      },
      {
        ...
        header: 'DASH Status',
        cell: ({ row }) => <span className="text-xs font-medium">{row.original.dashStatus}</span>,
      },
      {
        accessorKey: 'rentDate',
        header: 'Rent Date',
        cell: ({ row }) => <span>{new Date(row.original.rentDate).toLocaleDateString()}</span>,
      },
      {
        accessorKey: 'returnDate',
        header: 'Return Date',
        cell: ({ row }) => <span>{new Date(row.original.returnDate).toLocaleDateString()}</span>,
      },
      {
