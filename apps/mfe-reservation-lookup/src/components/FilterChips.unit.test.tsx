...
describe('FilterChips', () => {
  ...
  it('should render nothing when no filters are active', () => {
    const { container } = render(<FilterChips filters={emptyFilters} onRemoveFilter={vi.fn()} />);
  ...
  it('should render accessible remove buttons for each filter', () => {
    ...
    expect(screen.getByRole('button', { name: /remove start date filter/i })).toBeInTheDocument();
