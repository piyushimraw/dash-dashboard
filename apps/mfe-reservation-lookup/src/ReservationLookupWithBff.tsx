...
import { useGetRentedVehicleListWithBff } from "./features/rent-vehicle-bff/query";


export function ReservationLookupPageWithBff() {
  const isDesktop = useIsDesktop();
  const { data, isLoading } = useGetRentedVehicleListWithBff();
  const {
    initialFilters,
    filters,
    search,
