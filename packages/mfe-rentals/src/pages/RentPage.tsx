import { Button, DataTable } from "@dash/shared-ui";
import type { ColumnDef } from "@tanstack/react-table";
import { useMemo } from "react";
import { useGetRentedVehicleList } from "../features/rent-vehicle";
...
interface RentPageProps {
  onOpenRentDialog: () => void;
}

export default function RentPage({ onOpenRentDialog }: RentPageProps) {
