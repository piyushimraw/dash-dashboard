...
describe('AppPagination', () => {
  it('renders page numbers correctly', () => {
    render(<AppPagination page={1} pageSize={10} totalItems={50} onPageChange={vi.fn()} />);
  ...
  it('calls onPageChange when clicking a page', () => {
    ...
    render(<AppPagination page={1} pageSize={10} totalItems={50} onPageChange={onPageChange} />);
  ...
  it('goes to next page when clicking Next', () => {
    ...
    render(<AppPagination page={2} pageSize={10} totalItems={50} onPageChange={onPageChange} />);
  ...
  it('goes to previous page when clicking Previous', () => {
    ...
    render(<AppPagination page={3} pageSize={10} totalItems={50} onPageChange={onPageChange} />);
  ...
  it('does not render pagination if only one page', () => {
    const { container } = render(
      <AppPagination page={1} pageSize={10} totalItems={5} onPageChange={vi.fn()} />,
    );
  ...
  it('respects disabled prop', () => {
    ...
    render(
      <AppPagination page={2} pageSize={10} totalItems={50} disabled onPageChange={onPageChange} />,
    );
  ...
  it('marks the current page as active', () => {
    render(<AppPagination page={3} pageSize={10} totalItems={50} onPageChange={vi.fn()} />);
  ...
  it('disables Next button on last page', () => {
    ...
    render(<AppPagination page={5} pageSize={10} totalItems={50} onPageChange={onPageChange} />);
